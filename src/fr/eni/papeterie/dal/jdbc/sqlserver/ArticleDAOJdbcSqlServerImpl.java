...
public class ArticleDAOJdbcSqlServerImpl implements ArticleDAO {
    ...
    public Article selectById(Integer id_article) throws DALException {
        ...
        try {
            ...
            PreparedStatement etat_select = JdbcSqlServerTools.instanceConnectionSqlServer().prepareStatement(this.SQL_SELECT_BY_ID);
    ...
    public List<Article> selectAll() throws DALException {
        ...
        try {
            Statement etat_select = JdbcSqlServerTools.instanceConnectionSqlServer().createStatement();
    ...
    public void insert(Article article_a_insert) throws DALException {
        try  {
            ...
            PreparedStatement etat_insert = JdbcSqlServerTools.instanceConnectionSqlServer().prepareStatement(this.SQL_INSERT, Statement.RETURN_GENERATED_KEYS);
    ...
    public void update(Article article_a_update) throws DALException {
        try {
            PreparedStatement etat_update = JdbcSqlServerTools.instanceConnectionSqlServer().prepareStatement(this.SQL_UPDATE);
    ...
    public void delete(Integer id_article_a_delete) throws DALException {
        try {
            PreparedStatement etat_delete = JdbcSqlServerTools.instanceConnectionSqlServer().prepareStatement(this.SQL_DELETE);
