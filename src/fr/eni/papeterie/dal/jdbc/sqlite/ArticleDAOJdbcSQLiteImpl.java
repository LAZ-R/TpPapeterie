...
public class ArticleDAOJdbcSQLiteImpl implements ArticleDAO {
    ...
    public Article selectById(Integer id_article) throws DALException {
        ...
        try {
            ...
            PreparedStatement etat_select = JdbcSQLiteTools.instanceConnectionSQLite().prepareStatement(this.SQL_SELECT_BY_ID);
    ...
    public List<Article> selectAll() throws DALException {
        ...
        try {
            Statement etat_select = JdbcSQLiteTools.instanceConnectionSQLite().createStatement();
    ...
    public void insert(Article article_a_insert) throws DALException {
        try  {
            ...
            PreparedStatement etat_insert = JdbcSQLiteTools.instanceConnectionSQLite().prepareStatement(this.SQL_INSERT);
    ...
    public void update(Article article_a_update) throws DALException {
        try {
            PreparedStatement etat_update = JdbcSQLiteTools.instanceConnectionSQLite().prepareStatement(this.SQL_UPDATE);
    ...
    public void delete(Integer id_article_a_delete) throws DALException {
        try {
            PreparedStatement etat_delete = JdbcSQLiteTools.instanceConnectionSQLite().prepareStatement(this.SQL_DELETE);
